...
If a Trust heals you as an enemy dies and becomes your selected target, auto-engage waits. Press Cancel on your controller to clear that friendly target, then let the next enemy attack select a new target. The addon does not restore a cleared target or attack Trusts, friendly NPCs, or PCs.
